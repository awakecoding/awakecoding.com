...
```
Set-RDMUser [-User] <PSUserInfo> [-ForcePromptAnswer <DialogResult[]>] [-ProgressAction <ActionPreference>]
 [<CommonParameters>]
```
...
### None
## NOTES
For more information, type "Get-Help Set-RDMUser -detailed".
For technical information, type "Get-Help Set-RDMUser -full".
