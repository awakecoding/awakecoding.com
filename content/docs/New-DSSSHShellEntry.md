...
```
New-DSSSHShellEntry [-Group <String>] -Name <String> [-Password <String>] [-Description <String>]
 [-Tags <String>] [-DisplayMode <ConnectionDisplayMode>] [-DisplayMonitor <DisplayMonitor>]
 [-DisplayVirtualDesktop <DisplayVirtualDesktop>] [-VaultID <Guid>] [-AlwaysAskForPassword]
...
## DESCRIPTION
Create a new SSH Shell entry using supplied parameters.
New fields in RDM are automatically supported with the 'NewFieldsList' parameter
...
## NOTES
For more information, type "Get-Help New-DSSSHShellEntry -detailed".
For technical information, type "Get-Help New-DSSSHShellEntry -full".
